...
public class SwaggerConfig {
    @Bean
    public OpenAPI springStudyAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Project Pokemon")
                        .description("Project for study Spring Boot")
                        .version("v0.0.1")
                        .license(new License()
                                .name("HenriqueMendes")
                                .url("https://github.com/RiqueMendes"))
                        .contact(new Contact()
                                .name("Repository GitHub")
                                .url("https://github.com/RiqueMendes/Pokemon")
